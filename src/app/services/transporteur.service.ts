...
export class TransporteurService {
  ...
  readonly addtransporter="/api/v1/auth/registerTransporteur"
  ...
  addTransporter(transporter:Transporteur):Observable<AuthenticationResponse>{
    return this.http.post<AuthenticationResponse>(this.API_URL+this.addtransporter,transporter)
  }
